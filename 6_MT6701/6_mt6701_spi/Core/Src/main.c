...
/**
  * @brief  Read raw 14-bit angle data from MT6701 via SSI (SPI).
  * @retval 14-bit angle value (0~16383)
  */
...
/**
  ...
  * @retval Angle in degrees (0.0 ~ 360.0)
  */
...
/**
  * @brief  Redirect printf output to USART1.
  */
